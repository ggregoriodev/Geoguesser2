...
function RandomImage() {
  ...
  const fetchRandomImage = async () => {
    // Função para buscar imagem aleatória da API
  ...
  const Guess = () => {
    ...
    setGuess("");
    // Limpa o input após o palpite
    fetchRandomImage(); 
  };

  return (
    <div>
      <h2>Adivinhe a cidade</h2>
      {loading && <p>🔄 Carregando...</p>}{" "}
      {/* Mostra loading quando buscando */}
